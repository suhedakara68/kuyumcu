...
const DEFAULT_PRODUCTS = [
  { id: 'p1', name: 'Altın Kolye - Halat Zincir', category: 'kolye', karat: 22, weight: 8.5, price: 0, stock: 3, image: '/products/necklace.png', model3d: '/models/necklace.glb', emoji: '', laborCost: 250 },
  { id: 'p2', name: 'Bilezik - Burma Model', category: 'bilezik', karat: 22, weight: 15.2, price: 0, stock: 5, image: '/products/bracelet.png', model3d: '/models/bracelet.glb', emoji: '', laborCost: 400 },
  { id: 'p3', name: 'Tek Taş Yüzük', category: 'yuzuk', karat: 14, weight: 3.8, price: 0, stock: 8, image: '/products/ring.png', model3d: '/models/ring.glb', emoji: '', laborCost: 500 },
  { id: 'p4', name: 'Altın Küpe - Halka', category: 'kupe', karat: 18, weight: 4.2, price: 0, stock: 6, image: '/products/necklace.png', model3d: '/models/earring.glb', emoji: '', laborCost: 180 },
